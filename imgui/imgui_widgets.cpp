...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    RenderFrame(frame_bb.Min, frame_bb.Max, ImColor(0.5f, 0.5f, 0.5f, it_anim->second.animation), false, 9.0f);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    window->DrawList->AddRectFilled(frame_bb.Min, ImVec2(grab_bb.Min.x + 3, frame_bb.Max.y), ImColor(128, 128, 128), 5.0f);
