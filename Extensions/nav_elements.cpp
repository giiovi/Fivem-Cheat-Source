...
bool elements::tab(const char* name, bool boolean)
{
    ...
    window->DrawList->AddRectFilled(ImVec2(rect.Max.x + 5, rect.Min.y + 9), ImVec2(rect.Max.x + 8, rect.Max.y - 9), ImColor(1.0f, 1.0f, 1.0f, it_anim->second.rect_opacity), 10.0f, ImDrawFlags_RoundCornersLeft);
