...
const TextEditor::Palette& TextEditor::GetDarkPalette()
{
	const static Palette p = { {
			ImColor(95,96,95,255),	// Default
			ImColor(139, 102, 143,255),	// Keyword	
			ImColor(166, 206, 163,255),	// Number
			ImColor(164, 118, 99,255),	// String
			ImColor(164, 118, 99,255), // Char literal
			0xffffffff, // Punctuation
			ImColor(95,96,95,255),	// Preprocessor
			ImColor(171, 159, 97l,255), // Identifier
			0xff9bc64d, // Known identifier
			0xffc040a0, // Preproc identifier
			ImColor(225,225,225,255), // Comment (single line)
			ImColor(225,225,225,255), // Comment (multi line)
...
{
	const static Palette p = { {
			ImColor(150,150,150,255),	// Default				|| red
			ImColor(150,150,150,255),	// Keyword				|| Yellow
			ImColor(150,150,150,255),	// Number				|| Purple
			...
			ImColor(128, 128, 128, 120), // Selection			|| Green smh
			0x800020ff, // ErrorMarker
			0x40f08000, // Breakpoint
